defmodule RaffleyWeb.CharityLive.Form do
  ...
  def render(assigns) do
    ...
    <.simple_form for={@form} id="charity-form" phx-change="validate" phx-submit="save">
      ...
      <.input field={@form[:slugh]} type="text" label="Slugh" />
      <footer>
        <.button phx-disable-with="Saving..." variant="primary">Save Charity</.button>
        <.button navigate={return_path(@return_to, @charity)}>Cancel</.button>
      </footer>
    </.simple_form>
    """
  end
